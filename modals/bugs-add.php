<div class="modal main-comp add hide">
        <h4 class="modal-title">Create New Bug Report</h4>
        <div class="add-form">
            <form action="includes/bugs.inc.php" method="post">
                <input type="hidden" name="new" value="1">

                <label for="bug_desc">Description</label>
                <textarea id="bug_desc" name="bug_desc" rows="5" cols="33" required></textarea>
                ...
                <fieldset>
                    ...
                    <div>
                        <input type="radio" id="type-1" name="bug_category" value="functionality" checked>
                ...
                <fieldset>
                    ...
                    <div>
                        <input type="radio" id="status-1" name="bug_status" value="open" checked>
