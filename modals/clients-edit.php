<div class="modal main-comp edit hide">
        <h4 class="modal-title edit-header">Update Client Account</h4>
        <div class="add-form">
            <form action="includes/clients.inc.php" method="post">
                <input type="hidden" name="edit" id="client-id" value="">
                ...
                <input type="text" id="client-email" name="client_email" required>

                <fieldset>
                    <legend>Client Type</legend>
                    <div id="client-type">
                        <input type="radio" id="type-1" name="client_type" value="solo">
                ...
                <fieldset>
                    ...
                    <div id="client-status">
                        <input type="radio" id="status-1" name="client_status" value="active">
                ...
                <input type="text" id="client-referral" name="client_referral">
